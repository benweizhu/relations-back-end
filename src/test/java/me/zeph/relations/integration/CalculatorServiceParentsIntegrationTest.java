...
@WebAppConfiguration
public class CalculatorServiceParentsIntegrationTest {
	...
	public CalculatorServiceParentsIntegrationTest(Unit c1, Unit c2, Unit m1, Unit m2, Unit af1, Unit af2, double expectedPi) {
		this.c1 = c1;
		this.c2 = c2;
		this.m1 = m1;
		this.m2 = m2;
